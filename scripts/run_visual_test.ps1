...
$clientArgs = @(
    ...
    '-e', 'SUPERMARKET_GT_FAST_NAV=1',
    '-e', 'SUPERMARKET_GT_FAST_SHELF_POS_TOL=0.032',
    '-e', 'SUPERMARKET_GT_FAST_FINAL_YAW_TOL=0.055',
    '-e', 'SUPERMARKET_MAX_LINEAR=1.00',
    '-e', 'SUPERMARKET_LINEAR_ACCEL=2.00',
    '-e', 'SUPERMARKET_NAV_MIN_LINEAR=0.45',
    '-e', 'SUPERMARKET_WAYPOINT_BRAKE_ACCEL=1.20',
    '-e', 'SUPERMARKET_SHELF_APPROACH_LINEAR_CAP=0.55',
    '-e', 'SUPERMARKET_SHELF_CROSS_LINEAR_CAP=0.35',
    '-e', 'SUPERMARKET_SHELF_CROSS_ANGULAR_CAP=0.50',
    '-e', 'SUPERMARKET_FINAL_TURN_MAX_ANGULAR=0.65',
